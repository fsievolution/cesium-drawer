import { Entity, Cartesian2, defined, CallbackProperty, JulianDate, Cartesian3, ClassificationType, ArcType, PolygonHierarchy, Rectangle as Rectangle$1, Color } from 'cesium';
...
class Drawer {
  ...
  constructor(viewer, options) {
    this._option = {
      terrain: (options == null ? void 0 : options.terrain) ?? defaultOptions.terrain,
    ...
    this._viewer = viewer;
    this._terrain = this._option.terrain ?? defaultOptions.terrain;
